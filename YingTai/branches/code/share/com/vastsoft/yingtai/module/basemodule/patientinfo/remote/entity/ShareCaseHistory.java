...
/** 病例 */
public class ShareCaseHistory extends AbstractShareEntity {
	private long id;
	...
	private String treatment;//病床号

	public ShareCaseHistory() {
		super();
	}

	public ShareCaseHistory(ShareExternalSystemType systemType, String brand, String version) {
		super(systemType, brand, version);
	}

	public ShareCaseHistory(ShareSystemIdentity systemIdentity) {
		super(systemIdentity);
	}

	public ShareCaseHistory(long org_id, String case_his_num) {
		super();
		this.org_id = org_id;
	...
	public String getStatusStr() {
		CaseHistoryStatus sstatus = CaseHistoryStatus.parseCode(status);
		return sstatus==null?"":sstatus.getName();
	}
	...
	public ShareCaseHistory formatPropertys() {
		return null;
	}
	...
	public SharePatientDataType getPdType() {
		return SharePatientDataType.CASE_HIS;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ShareCaseHistory other = (ShareCaseHistory) obj;
	...
	protected void deserialize(JSONObject jsonObject) throws JSONException {
		...
		this.check_body = jsonObject.optString("check_body", "");
	...
	protected void replaceFrom(AbstractShareEntity entity) {
		ShareCaseHistory caseHistory = (ShareCaseHistory) entity;
	...
	protected void mergeFrom(AbstractShareEntity re) {
		ShareCaseHistory caseHistory = (ShareCaseHistory) re;
	...
	public static ShareCaseHistory findByCaseHisNumAndType(List<ShareCaseHistory> listCaseHostory, String case_his_num,
		...
		if (type == null)
			return null;
		for (ShareCaseHistory tCaseHistory : listCaseHostory) {
