...
public class TPatient extends AbstractRemoteEntity {
	private long id;
	// private String bingren_id;
	private String name;
	...
	public TPatient(ExternalSystemType systemType, String brand, String version) {
		super(systemType, brand, version);
	}

	public TPatient(SystemIdentity systemIdentity) {
	...
	public PatientDataType getPdType() {
		return PatientDataType.PATIENT_DA;
	}
	...
	public JSONObject serialize() throws JSONException {
		...
		r.put("contact_addr", contact_addr);
		r.put("contact_name", contact_name);
		r.put("contact_phone_num", contact_phone_num);
		r.put("contact_rela", contact_rela);
		r.put("create_time", DateTools.dateToString(create_time));
		r.put("gender", gender);
		r.put("home_address", home_address);
		r.put("identity_id", identity_id);
		r.put("marital_status", StringTools.isEmpty(marital_status) ? "未知" : marital_status);
		r.put("mingzu", StringTools.isEmpty(mingzu) ? "未知" : mingzu);
		r.put("name", name);
		r.put("phone_num", this.phone_num);
	...
	protected void replaceFrom(AbstractRemoteEntity entity) {
		TPatient patient = (TPatient) entity;
