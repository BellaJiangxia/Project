...
import com.vastsoft.utils.annotation.IgnoreNull;
...
import com.vastsoft.yingtaidicom.search.constants.ReportFomType;
...
public class TReport extends AbstractRemoteEntity{
	private long id;//
	...
	private long print_user_id;// 打印报告人
	...
	public TReport(ExternalSystemType systemType, String brand, String version) {
		super(systemType, brand, version);
	}

	public TReport(SystemIdentity systemIdentity) {
		super(systemIdentity);
	}

	public TReport(String dicom_img_mark_char, int type,SystemIdentity systemIdentity) {
		super(systemIdentity);
...
//
//	/** 通过诊断装载报告对象 */
//	public boolean buildFromDiagnosis(TDiagnosis diagnosis) {
//		if (diagnosis == null)
//			return false;
//		try {
//			this.case_eaf_list = diagnosis.getCase_eaf_list();
//			this.case_enter_time = diagnosis.getCase_enter_time();
//			this.case_his_id = diagnosis.getCase_his_id();
//			this.case_his_num = diagnosis.getCase_his_num();
//			this.case_hospitalized_num = diagnosis.getCase_hospitalized_num();
//			this.case_leave_time = diagnosis.getCase_leave_time();
//			this.case_reception_doctor = diagnosis.getCase_reception_doctor();
//			this.case_reception_section = diagnosis.getCase_reception_section();
//			this.case_source_type = diagnosis.getCase_source_type();
//			this.case_symptom = diagnosis.getCase_symptom();
//			this.case_type = diagnosis.getCase_type();
//			this.create_time = new Date();
//			this.diagnosis_id = diagnosis.getId();
//			this.dicom_img_check_pro = diagnosis.getDicom_img_check_pro();
//			this.dicom_img_check_time = diagnosis.getDicom_img_check_time();
//			this.dicom_img_checklist_num = diagnosis.getDicom_img_checklist_num();
//			this.dicom_img_device_type_id = diagnosis.getDicom_img_device_type_id();
//			this.dicom_img_id = diagnosis.getDicom_img_id();
//			this.dicom_img_mark_char = diagnosis.getDicom_img_mark_char();
//			this.dicom_img_part_type_id = diagnosis.getDicom_img_part_type_id();
//			this.dicom_img_thumbnail_uid = diagnosis.getDicom_img_thumbnail_uid();
//			this.note = diagnosis.getNote();
//			this.patient_birthday = diagnosis.getPatient_birthday();
//			this.patient_born_address = diagnosis.getPatient_born_address();
//			this.patient_gender = diagnosis.getPatient_gender();
//			this.patient_home_address = diagnosis.getPatient_home_address();
//			this.patient_identity_id = diagnosis.getPatient_identity_id();
//			this.patient_name = diagnosis.getPatient_name();
//			this.patient_sick_his = diagnosis.getPatient_sick_his();
//			this.patient_source_type = diagnosis.getPatient_source_type();
//			this.patient_work = diagnosis.getPatient_work();
//			this.publish_report_org_id = diagnosis.getPublish_report_org_id();
//			this.source_type = ReportSourceType.YUANZHEN.getCode();
//			return true;
//		} catch (Exception e) {
//			return false;
//		}
...
//	
//	/**通过病人，病例和影像装载报告*/
//	public void buildFromPatientAndCaseAndDicomImg(TPatient patient, TCaseHistory caseHostory, TDicomImg dicomImg) {
